writefile("gingercard.png", game:HttpGet("https://raw.githubusercontent.com/REEEPlayz/fuzzyengine/refs/heads/main/cards/gingercard.png", true))
...
gradient.Image = getcustomasset("gingercard.png")
...
ColorSequenceKeypoint.new(1, Color3.fromRGB(247, 117, 255))
}
