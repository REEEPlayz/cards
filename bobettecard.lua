writefile("c.png", game:HttpGet("https://raw.githubusercontent.com/REEEPlayz/fuzzyengine/refs/heads/main/cards/c.png", true))
writefile("b.png", game:HttpGet("https://raw.githubusercontent.com/REEEPlayz/fuzzyengine/refs/heads/main/cards/b.png", true))
...
holder.ItemDescrption.Position = UDim2.new(0.449999988, 0, 0.25999999, 0)
holder.ItemDescrption.Size     = UDim2.new(0.5, 0, 0.289999992, 0)
holder.ItemDescrption.TextStrokeTransparency = 0


holder.ItemName.Position = UDim2.new(0.49000001, 0, 0.0700000003, 0)
holder.ItemName.Size     = UDim2.new(0.400000006, 0, 0.120507024, 0)


holder.ItemImage.Position = UDim2.new(0.449999988, 0, 0.529999971, 0)
...
gradient.Image = getcustomasset("b.png")
...
playerholder.Position = UDim2.new(0.0399999991, 0, 0.0799999982, 0)
...
ColorSequenceKeypoint.new(0, Color3.fromRGB(223, 7, 7)),
ColorSequenceKeypoint.new(1, Color3.fromRGB(41, 137, 30))
}
...
divider.Image = getcustomasset("c.png")
divider.Size = UDim2.new(1.86000001, 0, 1, 0)
