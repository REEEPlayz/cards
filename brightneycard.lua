writefile("brightneycard.png", game:HttpGet("https://raw.githubusercontent.com/REEEPlayz/fuzzyengine/refs/heads/main/cards/brightneycard.png", true))
...
gradient.Image = getcustomasset("brightneycard.png")
...
ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 145, 145)),
ColorSequenceKeypoint.new(1, Color3.fromRGB(102, 58, 58))
}
...
fawzia.Color = halaa
fawzia.Rotation = 90
local brightneysnewskinissopretty = Instance.new("UIGradient")
brightneysnewskinissopretty.Parent = tempholder.Frame
brightneysnewskinissopretty.Color = halaa
brightneysnewskinissopretty.Rotation = 90
