writefile("looeycard.webp", game:HttpGet("https://files.catbox.moe/20a4xl.webp", true))
...
gradient.Image = getcustomasset("looeycard.webp")
...
ColorSequenceKeypoint.new(0, Color3.fromRGB(210, 193, 162)),
ColorSequenceKeypoint.new(1, Color3.fromRGB(180, 141, 142))
}
