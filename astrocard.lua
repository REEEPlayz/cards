writefile("astrocard.png", game:HttpGet("https://files.catbox.moe/b5q485.png", true))
...
gradient.Image = getcustomasset("astrocard.png")
...
ColorSequenceKeypoint.new(0, Color3.fromRGB(90, 166, 178)),
ColorSequenceKeypoint.new(1, Color3.fromRGB(189, 198, 177))
}
