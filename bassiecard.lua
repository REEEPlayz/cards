writefile("bassiechoose.mp3", game:HttpGet("https://raw.githubusercontent.com/REEEPlayz/fuzzyengine/refs/heads/main/cards/bassiechoose.mp3", true))
writefile("bassieflip.mp3", game:HttpGet("https://raw.githubusercontent.com/REEEPlayz/fuzzyengine/refs/heads/main/cards/bassieflip.mp3", true)) -- bassieflip.mp3
writefile("e.png", game:HttpGet("https://raw.githubusercontent.com/REEEPlayz/fuzzyengine/refs/heads/main/cards/e.png", true))
writefile("ba.png", game:HttpGet("https://raw.githubusercontent.com/REEEPlayz/fuzzyengine/refs/heads/main/cards/ba.png", true))
...
-- necessary because the image would move so
...
holder.ItemDescrption.Position = UDim2.new(0.449999988, 0, 0.300000012, 0)
holder.ItemDescrption.Size     = UDim2.new(0.5, 0, 0.300000012, 0)
holder.ItemDescrption.TextStrokeTransparency = 0


holder.ItemName.Position = UDim2.new(0.449999988, 0, 0.0700000003, 0)
holder.ItemName.Size     = UDim2.new(0.400000006, 0, 0.120507024, 0)


holder.ItemImage.Position = UDim2.new(0, 0, 0, 0)
...
gradient.Image = getcustomasset("ba.png")
...
playerholder.Position = UDim2.new(0.0399999991, 0, 0.400000006, 0)
...
ColorSequenceKeypoint.new(0, Color3.fromRGB(170, 170, 255)),
ColorSequenceKeypoint.new(1, Color3.fromRGB(233, 164, 255))
}
...
divider.Image = getcustomasset("e.png")
divider.Size = UDim2.new(2, 0, 1, 0)
divider.BackgroundTransparency = 1
divider.Parent = canvasgroup
clone.Choose.SoundId = getcustomasset("bassiechoose.mp3")
clone.Flip.SoundId = getcustomasset("bassieflip.mp3")
