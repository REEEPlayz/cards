writefile("boxtencard.webp", game:HttpGet("https://files.catbox.moe/m2bpd4.png", true))
...
gradient.Image = getcustomasset("boxtencard.webp")
...
ColorSequenceKeypoint.new(0, Color3.fromRGB(156, 49, 142)),
ColorSequenceKeypoint.new(1, Color3.fromRGB(120, 17, 102))
}
